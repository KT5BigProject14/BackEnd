...
Revision ID: c405890b02c6
Revises: c604e06a9a7c
Create Date: 2024-06-26 13:33:35.853267
...
revision: str = 'c405890b02c6'
down_revision: Union[str, None] = 'c604e06a9a7c'
...
def upgrade() -> None:
    ...
    sa.Column('keyword_id', sa.String(length=255), nullable=False),
    sa.Column('email', sa.String(length=255), nullable=False),
    ...
    sa.Column('reply_id', sa.String(length=255), nullable=False),
    sa.Column('board_id', sa.String(length=255), nullable=False),
    sa.Column('email', sa.String(length=255), nullable=False),
    sa.Column('content', sa.String(length=255), nullable=True),
    sa.Column('created_at', sa.String(length=255), nullable=True),
